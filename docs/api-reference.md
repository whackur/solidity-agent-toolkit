...
| `analyze_adversarial_scenarios` | Analyze Solidity contract code to identify applicable adversarial attack scenarios             |
...
| `adversarial://category/{category}` | Get adversarial scenarios by attack category (e.g., reentrancy, flash-loan)    |
| `adversarial://scenario/{id}`       | Get a specific adversarial attack scenario by ID (e.g., AS-001)                |
...
| `adversarial_analysis` | Guided adversarial scenario analysis for Solidity contracts from an attacker's perspective |
