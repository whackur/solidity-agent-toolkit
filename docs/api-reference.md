...
| `scan_vulnerability_patterns` | Scan Solidity code for vulnerability patterns using SCWE example matching and regex heuristics           | `code`, `mode?`: `"all"` \| `"scwe"` \| `"regex"`, `vulnerabilityId?`, `checkIds?`                                                                  |
